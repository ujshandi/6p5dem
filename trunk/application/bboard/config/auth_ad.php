...
$config['hosts'] = array('bpsdm.go.id');
...
$config['base_dn'] = 'DC=BPSDM,DC=go,DC=id';
...
$config['proxy_user'] = 'ikan@bpsdm.go.id';

// proxy pass: the password for the proxy_user
$config['proxy_pass'] = 'Razaan02';
