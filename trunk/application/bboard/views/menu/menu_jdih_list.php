		...
		<tbody>
			...
			<tr>
				...
				<td align="left" valign="top" class="table-actions">
					<a href="javascript:void(0);" onclick="edit_menu_jdih(<?=$row->MENU_ID?>)" class="control" ><span class="edit">edit</span></a> 
						|
					<a href="javascript:void(0);" onclick="hapus_menu_jdih(<?=$row->MENU_ID?>)" class="control" ><span class="delete">hapus</span></a> 
				</td>
			</tr>
			<?php $i++;} ?>
		</tbody>
	...
	<div class="clear">&nbsp;</div>
	<?=$this->pagination->create_ajax_links('ajaxpaging_jdih');?>
