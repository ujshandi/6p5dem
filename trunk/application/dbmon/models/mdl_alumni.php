...
class mdl_alumni extends CI_Model{
	...
	function getData($kode_induk='', $kode_prog='',$tahun=array('2005','2006','2007','2008','2009','2010','2011','2012','2013')){
		...
		$this->db->where('DIKLAT_MST_PESERTA.STATUS_PESERTA', 'Lulus');
	...
	public function getData2($e1,$e2,$tahun=array('2005','2006','2007','2008','2009','2010','2011','2012','2013')){
