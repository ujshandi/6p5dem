...
<div class="wrap_right bgcontent">
	...
	<fieldset>
		...
		<ol>
			...
			<li><label for="">Jenis Kelamin <em>*</em></label> <select id="JK">
			<option value="">- Pilih Jenis Kelamin -</option>
			<option value="Pria">Pria</option>
			<option value="Wanita">Wanita</option>
			</select></li>
			<li><label for="">Status Pengajar <em>*</em></label> <select id="STATUS">
			...
			<li><label for="">Jenis Pengajar <em>*</em></label> <select id="JENIS_DOSEN">
