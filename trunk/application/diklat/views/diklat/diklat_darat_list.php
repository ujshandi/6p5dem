...
<div class="wrap_right bgcontent">
	...
	if ($can_insert== TRUE){
	?>
	<a href="<?=base_url().$this->config->item('index_page').'/diklat_darat/add'?>" class="control"> <span class="add">Tambah Data </span></a>
	<?php
	}
	?>
	
	<?=form_open('diklat_darat/search', array('class'=>'sform'))?>
	<fieldset>
	<ol>
		<li>
			NAMA DIKLAT :
	...
	<table width="100%">
	  <thead>
		...
		<th <?php if ($sort_by == $field_name) echo "class=\"sort_$sort_order\"" ?>>
			<?php echo anchor("/diklat_darat/index/$field_name/". ##sorting
