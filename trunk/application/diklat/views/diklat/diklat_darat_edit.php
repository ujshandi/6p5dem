...
<div class="wrap_right bgcontent">
	<h1 class="heading">Edit Data Diklat Darat</h1>
	<hr/>
	<?=form_open('diklat_darat/proses_edit', array('class'=>'sform'))?>
	<fieldset>
		<?php 
		...
		<ol>
			...
			<li>
				...
				<select name="KODE_UPT">
					<?php 
						...
						echo $this->mdl_upt->getOptionUPTDarat($opti);
					?>
				</select>
			</li>
			...
			<li><label for="">PROGRAM <em>*</em></label>
				<select name="KODE_PROGRAM">
					<?php 
						...
						echo $this->mdl_program->getOptionProgramDarat($opti);
					?>
				</select>
			</li>
			...
			<li><label for="">NAMA DIKLAT <em>*</em></label> <textarea name="NAMA_DIKLAT"><?=$result->row()->NAMA_DIKLAT?></textarea></li>
