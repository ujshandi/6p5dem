...
<div class="wrap_right bgcontent">
	<h1 class="heading">Tambah Data Diklat Aparatur</h1>
	<hr/>
	<?=form_open('diklat_aparatur/proses_add', array('class'=>'sform'))?>
	<fieldset>
		<?php 
		...
		<ol>
			<li>
				...
				<select name="KODE_UPT">
					<?=$this->mdl_upt->getOptionUPTAparatur(array('value'=>$kode_upt))?>
				</select>
			</li>
			...
			<li>
				...
				<select name="KODE_PROGRAM">
					<?=$this->mdl_program->getOptionProgramAparatur(array('value'=>$kode_program))?>
				</select>
			</li>
			...
			<input type="hidden" name="KODE_INDUK" value="2">
