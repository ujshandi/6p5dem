...
<div class="wrap_right bgcontent">
	<h1 class="heading">Widyaiswara</h1>
	<hr/>
	<?=form_open('front/widyaiswara')?>
	...
	<?if($opt['value'] != ""){?>
		...
		<table width="100%" border="1" cellspacing="1" cellpadding="1">
			<tr>
				<th scope="col">No</th>
				<th scope="col">Nama Widyaiswara</th>
				<th scope="col">Jenis Kelamin</th>
				<th scope="col">Status Widyaiswara</th>
				<th scope="col">Tahun Mulai Mengajar</th>
				<th scope="col">Pendidikan/Kualifikasi</th>
			</tr>
			<?
				$result = $this->mdl_dosen->getDosenByUPT($opt['value'], 'Widyaiswara');
