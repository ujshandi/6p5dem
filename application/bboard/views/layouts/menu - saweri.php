		...
		<ul class="container_12">
			...
			<li class="home current">
				<ul> 
						...
												<li class="with-menu"><a href="javascript:void(0)" title="My settings">Kas dan Bank</a>							<div class="menu">								<img src="images/menu-open-arrow.png" width="16" height="16">								<ul>									<?php																			if ($privilage['kas_awal'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('kas_awal/index','Kas Awal').'</li>'; 										}else{											echo '<li class="icon_blog">Kas Awal</li>'; 										}																						if ($privilage['penerimaan_kas'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('penerimaan_kas/index','Penerimaan Kas').'</li>'; 										}else{											echo '<li class="icon_blog">Penerimaan Kas</li>'; 										}																				if ($privilage['pengeluaran_kas'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('pengeluaran_kas/index','Pengeluaran Kas').'</li>'; 										}else{											echo '<li class="icon_blog">Pengeluaran Kas</li>'; 										}											?>										<li class="sep"></li>										<?php										if ($privilage['posting_keluar'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('posting_keluar/index','Posting Pembelian').'</li>'; 										}else{											echo '<li class="icon_blog">Posting Pembelian</li>'; 										}																				if ($privilage['posting_masuk'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('posting_masuk/index','Posting Penjualan').'</li>'; 										}else{											echo '<li class="icon_blog">Posting Penjualan</li>'; 										}																													/*if ($privilage['pengeluaran_kas'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('pengeluaran_kas/index','Pengeluaran Kas').'</li>'; 										}else{											echo '<li class="icon_blog">Pengeluaran Kas</li>'; 										} */																				?>										<li class="sep"></li>										<?php										if ($privilage['mutasi_kas'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('mutasi_kas/index','Mutasi Kas').'</li>'; 										}else{											echo '<li class="icon_blog">Mutasi Kas</li>'; 										}																																								if ($privilage['refund'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('refund/index','Refund').'</li>'; 										}else{											echo '<li class="icon_blog">Refund</li>'; 										}																				?>										<li class="sep"></li>										<?php																				if ($privilage['hutang'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('hutang/pembayaran','Pembayaran Hutang').'</li>'; 										}else{											echo '<li class="icon_blog">Pembayaran Hutang</li>'; 										}																				if ($privilage['posting_hutang'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('posting_hutang/index','Posting Hutang').'</li>'; 										}else{											echo '<li class="icon_blog">Posting Hutang</li>'; 										}																			?>									<li class="sep"></li>									<?php																					if ($privilage['piutang'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('piutang/pembayaran','Pembayaran Piutang').'</li>'; 										}else{											echo '<li class="icon_blog">Pembayaran Piutang</li>'; 										}																				if ($privilage['posting_piutang'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('posting_piutang/index','Posting Piutang').'</li>'; 										}else{											echo '<li class="icon_blog">Posting Piutang</li>'; 										}																					?>																			<?php /*										if ($privilage['posting_mutasi_kas'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('posting_mutasi_kas/index','Posting Mutasi Kas').'</li>'; 										}else{											echo '<li class="icon_blog">Posting Mutasi Kas</li>'; 										}*/																			?>																	</ul>							</div>						</li>												<!--						<li class="with-menu"><a href="javascript:void(0)" title="My settings">Hutang</a>							<div class="menu">								<img src="images/menu-open-arrow.png" width="16" height="16">								<ul>									<?php/*										if ($privilage['master_hutang'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('hutang/index','Master Hutang').'</li>'; 										}else{											echo '<li class="icon_blog">Master Hutang</li>'; 										}										*/																																												?>								</ul>							</div>						</li>-->											<!--	<li class="with-menu"><a href="javascript:void(0)" title="My settings">PIUTANG</a>							<div class="menu">								<img src="images/menu-open-arrow.png" width="16" height="16">								<ul>									<?php  /*										if ($privilage['piutang'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('piutang/index','Master Piutang ').'</li>'; 										}else{											echo '<li class="icon_blog">Master Piutang</li>'; 										}																														*/									?>								</ul>							</div>						</li>-->																		<li class="with-menu"><a href="javascript:void(0)" title="My settings">Laporan</a>							<div class="menu">								<img src="images/menu-open-arrow.png" width="16" height="16">								<ul>									<?php										if ($privilage['laporan_biaya'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('laporan_biaya','Laporan Biaya').'</li>'; 										}else{											echo '<li class="icon_blog">Laporan Biaya</li>'; 										}																				if ($privilage['laporan_buku_kas'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('laporan_buku_kas','Laporan Buku Kas').'</li>'; 										}else{											echo '<li class="icon_blog">Laporan Buku Kas</li>'; 										}																				if ($privilage['laporan_laba_rugi'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('laporan_laba_rugi','Laporan Laba Rugi').'</li>'; 										}else{											echo '<li class="icon_blog">Laporan Laba Rugi</li>'; 										}																				if ($privilage['laporan_hutang'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('laporan_hutang','Laporan Hutang [Supplier]').'</li>'; 										}else{											echo '<li class="icon_blog">Laporan Hutang [Supplier]</li>'; 										}																				if ($privilage['laporan_piutang'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('laporan_piutang','Laporan Piutang [Pelanggan]').'</li>'; 										}else{											echo '<li class="icon_blog">Laporan Piutang [Pelanggan]</li>'; 										}									?>										<li class="sep"></li>									<?php																																						if ($privilage['laporan_pembayaran_hutang'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('laporan_pembayaran_hutang','Laporan Pembayaran Hutang').'</li>'; 										}else{											echo '<li class="icon_blog">Laporan Pembayaran Hutang</li>'; 										}																														if ($privilage['laporan_pembayaran_piutang'][0] == 1){ 											echo '<li class="icon_blog">'.anchor('laporan_pembayaran_piutang','Laporan Pembayaran Piutang').'</li>'; 										}else{											echo '<li class="icon_blog">Laporan Pembayaran Piutang</li>'; 										}									?>								</ul>							</div>						</li>
