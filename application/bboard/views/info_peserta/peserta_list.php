...
<div class="wrap_right bgcontent">
	...
	<div id="lmenu" class="bgtrans">
		<ul id="vmenu">
			<li><a href="<?=base_url()?>/index.php/peserta_frontpage/hid_filter/<?php echo $kode_upt;?>" class="active">Data Peserta</a></li>
			...
			<li><a href="<?=base_url()?>/index.php/dosen_frontpage/hid_filter/<?php echo $kode_upt;?>/Widyaiswara">Data Widyaiswara</a></li>
		</ul><!-- end vmenu -->
	</div>	
	<br>
