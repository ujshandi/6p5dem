...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" > 
	<head>
		...
		<script type="text/javascript" src="<?=base_url()?>/asset/board/asset/login/js/jquery-1.4.2.min.js" ></script>
		
		<!-- Login javscript--> 
		<script type="text/javascript" src="<?=base_url()?>/asset/board/asset/login/js/loginui.js"></script> 
		
		<link rel="stylesheet" type="text/css" media="all" href="<?=base_url()?>/asset/board/asset/login/css/reset.css" />
		<link rel="stylesheet" type="text/css" media="all" href="<?=base_url()?>/asset/board/asset/login/css/login.css" />
		<link rel="stylesheet" type="text/css" media="all" href="<?=base_url()?>/asset/board/asset/login/css/blue.css" />
		
		<!-- comment extra.css for css validation -->
		<link rel="stylesheet" type="text/css" media="all" href="<?=base_url()?>/asset/board/asset/login/css/extra.css" />
