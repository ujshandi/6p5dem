...
class MY_Controller extends CI_Controller{
	...
	}			function open_backend(){							$data = $this->session->userdata('dataUser');			//$users=$this->Authentikasi->getDataUser($data['USER_ID']);		$data['results'] = $this->Authentikasi->getDataUser($data['USER_ID']);				$query = $this->Authentikasi->listMenuUser($data["USER_ID"]);						$arrGroupingMenu = $this->_listMenuUser($query);																					$data['menuUser'] = $this->build_menu($arrGroupingMenu);								$this->load->view('layouts_backend/header',$data);		$this->load->view('layouts_backend/menu', $data);	}		function close_backend(){		$this->load->view('layouts_backend/footer');	}
