	...
	$.jsonp({
		...
		$.each(data, function(i, item){
				...
				if(exe){
					...
					if(first){shpLayers[i].events.register('loadstart', this, showLoading);first=false;};
					last=i;
...
function showLoading(){
	...
	loading.setAttribute('class','peeek-loading');
	loading.innerHTML = '<ul><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li></ul>';
