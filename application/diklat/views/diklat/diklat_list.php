...
<div class="wrap_right bgcontent">
	...
	<hr/>
	<a href="<?=base_url().$this->config->item('index_page').'/diklat_darat'?>" class="control"><span class="add">Kelola Data Diklat Darat</span></a>
	<a href="<?=base_url().$this->config->item('index_page').'/diklat_laut'?>" class="control"><span class="add">Kelola Data Diklat Laut</span></a>
	<a href="<?=base_url().$this->config->item('index_page').'/diklat_udara'?>" class="control"><span class="add">Kelola Data Diklat Udara</span></a>
	<a href="<?=base_url().$this->config->item('index_page').'/diklat_aparatur'?>" class="control"><span class="add">Kelola Data Diklat Aparatur</span></a>
	<a href="<?=base_url().$this->config->item('index_page').'/diklat_sekretariat'?>" class="control"><span class="add">Kelola Data Diklat Sekretariat</span></a>
