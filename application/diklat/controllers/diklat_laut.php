...
class diklat_laut extends My_Controller {
	...
	function __construct(){
		...
		$this->load->model('mdl_diklat_laut');
	}
	...
	public function index($sort_by ='KODE_DIKLAT', $sort_order ='ASC') ##sorting
	{
		...
		# get data
		$result = $this->mdl_diklat_laut->getData($data['numrow'], $offset, $data, $sort_by, $sort_order);
		
		# config pagination
		$config['base_url'] = base_url().'/'.$this->config->item('index_page').'/diklat_laut/index/'."$sort_by/$sort_order"; ##sorting
		...
		$this->load->view('diklat/diklat_laut_list', $data);
	...
	public function add(){
		$this->open();
		$this->load->view('diklat/diklat_laut_add');
		$this->close();
	}
	...
	public function edit($id){
		...
		$data['id'] = $id;
		$data['result'] = $this->mdl_diklat_laut->getDataEdit($id);
	...
	public function proses_edit(){
		...
		if ($this->form_validation->run() == FALSE){
			$data['result'] = $this->mdl_diklat_laut->getDataEdit($data['id']);
			$this->load->view('diklat/diklat_laut_edit',$data);
		}else{
	...
	public function proses_delete($id){
		if($this->mdl_diklat_laut->delete($id)){
			redirect('diklat_laut');
		}else{
