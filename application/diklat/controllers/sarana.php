...
class sarana extends My_Controller {
	...
	public function index($sort_by ='NAMA,JUMLAH,TAHUN', $sort_order ='ASC') ##sorting
	{
		$this->open();
		...
		# config pagination
		$config['base_url'] = base_url().'/'.$this->config->item('index_page').'/sarana/index/'."$sort_by/$sort_order";
