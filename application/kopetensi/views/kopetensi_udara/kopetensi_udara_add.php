...
<?=form_close()?>
		...
		?>
                <ol>
					...
					<li><label for="">Kode Kopetensi <em>*</em></label> <input name="KODE_KOPETENSI_UDARA" value="<?=set_value('KODE_KOPETENSI_UDARA')?>" type="text" class="three"/></li>
                    <li><label for="">Deskripsi <em>*</em></label> <input name="NAMA_KOPETENSI" value="<?=set_value('NAMA_KOPETENSI')?>" type="text" class="eight"/></li>
        ...
        $("#KODE_KATEG_KOPETENSI").change(function(){
                ...
                if (selectValues == 0){
                    ...
                    $.ajax({
                            type: "POST",
                            url : "<?php echo site_url('kopetensi_udara/select_tingkat2')?>",
