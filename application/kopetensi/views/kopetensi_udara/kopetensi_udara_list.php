   ...
   Tingkat Kompetensi :<br/>
	...
	<table width="100%">
	  ...
	  ?>
		<tr>
				<td width='5%'><?=$i?></td>
				<td width='8%'><?=$row->KODE_KOPETENSI_UDARA?></td>
				<td width='30%'><?=$row->NAMA_KOPETENSI?></td>
				<td width='6%'>
					<a href="<?=site_url().'/kopetensi_udara/edit/'.$row->KODE_KOPETENSI_UDARA?>" class="control">
						<span class="edit">edit</span>
					</a>
					<a href="<?=site_url().'/kopetensi_udara/proses_delete/'.$row->KODE_KOPETENSI_UDARA?>" OnClick="return confirm('Apakah anda benar akan menghapus data?')" class="control">
