<html>
    ...
    <body>
        ...
        <img src="images/miniBanner.png" style="float:left; margin-left:0;">
        ...
        <ul id="nav" style="margin-left:253px;">
			...
			<ul id="menu" style="margin-top:52px; float:right; margin-right: 2px;">
                <li><a href="#"><input type="checkbox" name="shp"> Batas Administrasi</a></li>
        ...
        <div id="description" style="padding-left:3px; padding-top:3px;">
        	<div id="lokasi">  
            	<div class="bgtitle"><img src="images/symbol/SDall.png" style="height:10px; width:10px;">Sekolah Dasar</div>
            	<p><input type="checkbox" name="test1">&nbsp;Sekolah Dasar</p>
                <span style="margin-left:15px;"><input type="checkbox" name="test1">&nbsp;Sekolah Dasar Negeri</span><br/>
                <span style="margin-left:15px;"><input type="checkbox" name="test1">&nbsp;Sekolah Dasar Swasta</span>
    			<p>&nbsp;</p>
                <div class="bgtitle"><img src="images/symbol/SMPall.png" style="height:10px; width:10px;">Sekolah Menengah Pertama</div>
                <p><input type="checkbox" name="test1">&nbsp;Sekolah Menengah Pertama</p>
                <span style="margin-left:15px;"><input type="checkbox" name="test1">&nbsp;Sekolah Menengah Pertama Negeri</span><br/>
                <span style="margin-left:15px;"><input type="checkbox" name="test1">&nbsp;Sekolah Menengah Pertama Swasta</span>
    			<p>&nbsp;</p>              
                <div class="bgtitle"><img src="images/symbol/SMAall.png" style="height:10px; width:10px;">Sekolah Menengah Atas</div>  
                <p><input type="checkbox" name="test1">&nbsp;Sekolah Menengah Atas</p>
                <span style="margin-left:15px;"><input type="checkbox" name="test1">&nbsp;Sekolah Menengah Atas Negeri</span><br/>
                <span style="margin-left:15px;"><input type="checkbox" name="test1">&nbsp;Sekolah Menengah Atas Swasta</span>
    			<p>&nbsp;</p>                
                <div class="bgtitle"><img src="images/symbol/PTall.png" style="height:10px; width:10px;">Perguruan Tinggi</div>
                <p><input type="checkbox" name="test1">&nbsp;Perguruan Tinggi</p>
                <span style="margin-left:15px;"><input type="checkbox" name="test1">&nbsp;Perguruan Tinggi Negeri</span><br/>
                <span style="margin-left:15px;"><input type="checkbox" name="test1">&nbsp;Perguruan Tinggi Swasta</span>
            </div>
        </div>
